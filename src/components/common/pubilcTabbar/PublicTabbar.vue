<template>
    <div>
        <tabBar>
            <tabBarItem path='/home' activeColor="#e25858">
            ...
            <tabBarItem path='/category' activeColor="#e25858">
            ...
            <tabBarItem path='/cart' activeColor="#e25858">
            ...
            <tabBarItem path='/profile' activeColor="#e25858">
